...
function PANEL:Init()
	...
	self.List.OnClickLine = function() return end
...
function PANEL:Think()
	...
	if input.IsMouseDown( MOUSE_LEFT ) then -- Click to activate mouse in scoreboard
		if input.IsButtonDown( KEY_TAB ) then
			g_ScoreBoard:SetMouseInputEnabled(true)
		end
	end
end
