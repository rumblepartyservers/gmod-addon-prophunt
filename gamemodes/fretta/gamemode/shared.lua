...
GM.SecondsBetweenTeamSwitches = 1	-- The minimum time between each team change?
...
if SERVER then
	...
	util.AddNetworkString( "BCSound" )
	util.AddNetworkString( "MsgC" )
	
	function BroadcastSound(path)
		net.Start("BCSound")
...
elseif CLIENT then
	...
	net.Receive("ColoredMessage",function(len)
		...
		for i = 1, length do
			...
			local func = (typ == 1) and net.ReadColor or net.ReadString
			ret[#ret + 1] = func()
		end
	...
	net.Receive("BCSound",function(len) 
